...
async function makeImage({ one, two }) {
    ...
    let pathImg = __root + `/liemnach${one}_${two}.png`;
    ...
    batgiam_img.resize(645, 902).composite(circleOne.resize(170, 170), 46, 584).composite(circleTwo.resize(220, 220), 316, 204);
