...
module.exports.handleEvent = async ({ event, api, Currencies,Users, args, utils, global, client }) => {
    ...
    var msg = {
                body: `Bất ngờ chưa ${name} đây là dấu lệnh của bot này là : [ / ] hoặc [ ! ] nếu không được ạ trong trường hợp có 1 số box thì là lệnh này ạ lưu ý nhé [ . ]\n Nếu bạn cần giúp đỡ về lệnh hãy dùng /menu + lệnh để xem cách dùng hoặc tag admin @Evill Nguyễn nếu trong trường hợp cần thiết nhé ạ :3 `,
